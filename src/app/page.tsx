...
const STATS = [
  { value: 1200, suffix: "+", label: "Participants attendus", icon: Users },
  { value: 30, suffix: "", label: "Méthodes présentées", icon: Microscope },
  { value: 15, suffix: "+", label: "Pays représentés", icon: MapPin },
  { value: 24, suffix: "h", label: "De formation immersive", icon: Clock },
];
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <motion.div initial={{ opacity: 0, x: 40 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.8, delay: 0.2 }} className="space-y-6">
            ...
            <div className="grid grid-cols-2 gap-4 pt-4">
              {[{ icon: Award, label: "15+ ans d'expertise" }, { icon: BookOpen, label: "30+ publications" }, { icon: Users, label: "5000+ professionnels formés" }, { icon: MapPin, label: "Conférences dans 15+ pays" }].map((item) => (
