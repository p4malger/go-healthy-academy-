...
export const DEFAULTS = {
  LOGO_IMG: "/logo.png",
  SPEAKER_IMG: "/speaker-photo.jpeg",

  /** Collez ici le lien YouTube complet de la vidéo de présentation */
  VIDEO_PRESENTATION_URL: "https://www.youtube.com/watch?v=dQw4w9WgXcQ",

  /** Collez ici le lien YouTube complet de la vidéo témoignage */
  VIDEO_TESTIMONIAL_URL: "https://www.youtube.com/watch?v=ysz5S6PUM-U",
  ...
  GALLERY_IMG_1: "/gallery-1.jpg",
  GALLERY_IMG_2: "/gallery-2.jpg",
  GALLERY_IMG_3: "/gallery-3.jpg",
  GALLERY_IMG_4: "/gallery-4.jpg",
  GALLERY_IMG_5: "/gallery-5.jpg",
  GALLERY_IMG_6: "/gallery-6.jpg",

  /** Conférencier */
  SPEAKER_NAME: "Dr Haddad Mohamed",
  SPEAKER_TITLE: "Docteur en Sciences Médicales",
  SPEAKER_BIO:
    "Chercheur et conférencier international spécialisé dans la médecine quantique et la nano médecine appliquées à la santé. Plus de 15 ans d'expertise dans la recherche médicale et la formation professionnelle.",
